...
var currentSelect:Int = 0;
    ...
    function monitorStuff() {
        ...
        screen.frames = Paths.getSparrowAtlas('RT stuff/userinterface/desktop/monitorParts');
        ...
        for(i => name in menuItems) {
            ...
            entry.frames = Paths.getSparrowAtlas('RT stuff/userinterface/desktop/icons');
        ...
        taskbar.frames = Paths.getSparrowAtlas('RT stuff/userinterface/desktop/monitorParts');
...
function create() {
        ...
        creditspad.loadGraphic(Paths.image("RT stuff/credits/creditspad"));
        creditspad.updateHitbox();
        creditspad.screenCenter();
        add(creditspad);

        creditspadDummy = new FlxSprite(mx+140, my+100);
        creditspadDummy.loadGraphic(Paths.image("RT stuff/credits/creditspadDummy"));
        creditspadDummy.updateHitbox();
        creditspadDummy.screenCenter();
        add(creditspadDummy);
        ...
        scrollBTNup.frames = Paths.getSparrowAtlas('RT stuff/credits/padButtons');
        ...
        scrollBTNdown.frames = Paths.getSparrowAtlas('RT stuff/credits/padButtons');
        ...
        windowBTNdisabled.frames = Paths.getSparrowAtlas('RT stuff/credits/padButtons');
        ...
        windowBTNx.frames = Paths.getSparrowAtlas('RT stuff/credits/padButtons');
        ...
        scrollbarMid.loadGraphic(Paths.image("RT stuff/credits/scrollbarMid"));
        add(scrollbarMid);
    
        scrollbarBottom = new FlxSprite(scrollbarMid.x, 100);
        scrollbarBottom.loadGraphic(Paths.image("RT stuff/credits/scrollbarBottom"));
        scrollbarBottom.updateHitbox();
        add(scrollbarBottom);
    
        scrollbarTop = new FlxSprite(scrollbarMid.x, 100);
        scrollbarTop.loadGraphic(Paths.image("RT stuff/credits/scrollbarTop"));
 ...
 var introTmr:FlxTimer;
    ...
    function addMyFellas(){
        ...
        for (i in 0...buddies.length){
            ...
            entry.frames = Paths.getSparrowAtlas('RT stuff/credits/creditbutton');
            ...
            names.setFormat(Paths.font("vcr.ttf"), 30);
            ...
            icon.loadGraphic(Paths.image("RT stuff/credits/icons/" + buddies[i].name));
  ...
  var boyfriendMode:Bool = false;
    ...
    function whoIsThisKid(id:Int) {
        ...
        contributions.setFormat(Paths.font("vcr.ttf"), 20);
        ...
        quote.setFormat(Paths.font("vcr.ttf"), 15);
        quote.color=0xFFC3C3C3;
        quote.alignment="center";
        add(quote);

        returnbutton = new FlxSprite(30, 30);
        returnbutton.frames = Paths.getSparrowAtlas('RT stuff/credits/returnbutton');
        ...
        switch (buddies[id].name) {
            ...
            case 'Adrix':
                var adrixfuckingDied = new FlxSprite().loadImage('RT stuff/credits/images/adrix');
            ...
            case 'Data':
                var data = new FlxSprite().loadImage('RT stuff/credits/images/data');
        ...
        if(evilMode){ //heeyyy... why does she get her OWN mode, and i don't! grrrrr......... -paige
            ...
            quote2.setFormat(Paths.font("vcr.ttf"), 15);
            ...
            quote3.setFormat(Paths.font("vcr.ttf"), 15);
            ...
            quote4.setFormat(Paths.font("vcr.ttf"), 15);
            ...
            quote5.setFormat(Paths.font("vcr.ttf"), 15);
